...
class NewProductScreen extends StatefulWidget {
  ...
  const NewProductScreen({super.key, required this.user, required this.position, required this.placemarks});
...
class _NewProductScreenState extends State<NewProductScreen> {
                ...
                Row(children: [
                    ...
                    Flexible(
                        ...
                        child: CheckboxListTile(
                          title: const Text("Carpark"), //    <-- label
                          value: _isChecked,
  ...
  void insertProduct() {
    ...
    http.post(Uri.parse("${Config.server}/homestayraya/php/insert_homestay.php"), body: {
